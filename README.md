...
This is a resource pack that contains additional icons to use as JourneyMap waypoints, also replacing the default icons to keep the icon style consistent.
